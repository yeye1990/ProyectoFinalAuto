...
namespace ProyectoFinal_ECommerceAutomationFramework.ECommerceTests.ECommerceUI.ECommerceLogin
{
    public class ECommerceLoginFormTest : DriverBase
    {
        ...
        /// <summary>
        /// Caso de prueba que valida el comportamiento del sistema ante un intento
        /// de inicio de sesión con credenciales no válidas.
        /// Usa los datos provenientes de un archivo JSON a través de la clase DataLoginInvalido.
        /// </summary>
        /// <param name="nombre">Nombre de usuario incorrecto.</param>
        ...
        public void Test_LoginInvalido(string nombre, string contrasenna, string assert_error_message)
        {
            ...
            //Assert
            Assert.That(mensajeError, Is.EqualTo(assert_error_message));
        }
    }
}
