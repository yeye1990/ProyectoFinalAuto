...
namespace ProyectoFinal_ECommerceAutomationFramework.ECommerceTests.ECommerceUI.ECommerceProductosCarrito.Data
{
    internal class DataAgregarProductosCarrito
    {
        ...
        /// </summary>
        public static IEnumerable<TestCaseData> GetJsonDataAgregarProductos()
        {
            ...
            var filePath = Path.GetFullPath(
                Path.Combine(
                    ...
                    @"..", @"..", @"..",
                    "ECommerceTests", "ECommerceUI", "ECommerceProductosCarrito", "Data", "AgregarProductosCarrito", "AgregarProductosCarritoData.json"
                )
            );

            // Usa la ruta construida dinámicamente
            var data = JsonReaderBase.GetTestData<DataAgregarProductosCarrito>(filePath);
